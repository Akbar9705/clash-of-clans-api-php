      ...
      <div class="row">
        <div class="table-responsive table-bordered movie-table">
          ...
          <table class="table movie-table" style=" font-size: 18px; ">
            ...
            <?php if($heroes['0']){?>
              <tr class="dark-row ">
                <td><img src="https://wiki.clashofclans.fr/images/thumb/8/85/VignettesRoi-D-A-T-R-D-300px.png/200px-VignettesRoi-D-A-T-R-D-300px.png" alt=""></td>
             ...
             <?php if($heroes['1']){?>
              <tr class="dark-row ">
                <td><img src="https://wiki.clashofclans.fr/images/thumb/8/85/VignettesReine-D-A-T-R-D-300px.png/200px-VignettesReine-D-A-T-R-D-300px.png" alt=""></td>
             ...
             <?php if($heroes['2']){?>
              <tr class="dark-row ">
               <td><img src="https://wiki.clashofclans.fr/images/thumb/5/57/VignettesGardien-D-A-T-R-D-300px.png/200px-VignettesGardien-D-A-T-R-D-300px.png" alt=""></td>
             ...
             <?php if($heroes['3']){?>
              <tr class="dark-row ">
                <td><img src="https://i.imgur.com/DWC8oJT.jpg" alt=""></td>
             ...
             <?php if($heroes['4']){?>
              <tr class="dark-row ">
                <td><img src="https://wiki.clashofclans.fr/images/thumb/c/c0/VignettesChampionne-D-A-T-R-D-300px.png/200px-VignettesChampionne-D-A-T-R-D-300px.png" alt=""></td>
